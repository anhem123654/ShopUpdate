...
namespace eShopSolution.ApiIntegration
{
    public class UserApiClient : IUserApiClient
    {
        ...
        public async Task<ApiResult<bool>> RegisterUser(RegisterRequest request)
        {
            ...
            var response = await client.PostAsync($"/api/users", httpContext);
            var reuslt = await response.Content.ReadAsStringAsync();
            if (response.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<ApiSuccessResult<bool>>(reuslt);
            }
            return JsonConvert.DeserializeObject<ApiErrorResult<bool>>(reuslt);
        }

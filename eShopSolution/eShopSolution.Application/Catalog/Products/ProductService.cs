...
namespace eShopSolution.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public async Task<int> AddImage(int productId, ProductImagCreateRequest request)
        {
        ...
        public async Task<PagedResult<ProductVm>> GetAllPaging(GetMangeProductPagingRequest request)
        {
            //1. Select join
        ...
        public async Task<int> UpdateImage(int imageId, ProductImagUpdateRequest request)
        {
            var productImage = await _context.ProductImages.FindAsync(imageId);
            if (productImage == null)
                throw new EShopException($"Cannot find an image with id {imageId}");
